...
class NavBarTemplate {
  ...
  static buildTripletItems(List<IconData> icons, List<String> labels) {
    return [
      ...
      BottomNavigationBarItem(icon: Icon(icons[1]), title: Text(labels[1])),
    ];
  }

  static buildBottomNavBar(
      NavBar navBar,
  ...
  static Widget buildAppBar(BuildContext context, List<int> colorsList,
      String tittle, Widget bodyWidget) {
    return new Scaffold(
      appBar: new AppBar(
        elevation: 0.0,
        ...
        title: Text(tittle,
            style: TextStyle(
                color: Color(colorsList[2]), fontWeight: FontWeight.w700)),
        leading: new IconButton(
          color: Colors.black,
          onPressed: () => Navigator.of(context).pop(),
          icon: Icon(Icons.arrow_back, color: Color(colorsList[2])),
        ),
      ),
      body: new Center(
        child: bodyWidget,
